...
# config & logging
from config_updates import add_configs, pretrained_audioset, dataset_path
...
# this happends via the commands
...
def default_conf():
    ...
    t4_paths = dict(
        ...
        pseudo_labels=os.path.join(base_path, "predictions/{}/{}.hdf5"),
...
@ex.command(prefix="optimizer")
def get_optimizer(
        model, arch, crnn_lr=0.001, pt_lr=0.0, pt_lr_scale=1.0, pt_trainable_layers=0,
        adamw=True, weight_decay=1e-2, betas=[0.9, 0.999],
):
